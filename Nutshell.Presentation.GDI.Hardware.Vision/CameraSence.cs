...
namespace Nutshell.Presentation.GDI.Hardware.Vision
{
        /// <summary>
        ///         Class CameraRender.
        /// </summary>
        public abstract class CameraSence : CycleSence
        {
                ...
                protected override void Render(IntPtr hdc)
                {
                        //Win32GDIAPI.TextOut(hdc, 20, 20, Camera.Id, Camera.Id.Length);
                        //hdc.DrawString(Camera.Id, YaHei36Font, Brushes.LawnGreen, 20, 20);
                }                
        }
}