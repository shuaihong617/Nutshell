...
namespace Nutshell.RabbitMQ
{
	...
	///         RabbitMQ认证数据模型接口
	/// </summary>
	public class RabbitMQQueue : StorableObject,IStorable<IRabbitMQQueueModel>
	{
		/// <summary>
		///         获取或设置名称
		/// </summary>
		...
		public void Load(IRabbitMQQueueModel model)
		{
			base.Load(model);
		...
		public void Save(IRabbitMQQueueModel model)
		{
