...
namespace Nutshell.RabbitMQ
{
	...
	///         RabbitMQ交换机
	/// </summary>
	public class RabbitMQExchange : StorableObject, IStorable<IRabbitMQExchangeModel>
	{
		/// <summary>
		///         获取或设置名称
		/// </summary>
		...
		public void Load(IRabbitMQExchangeModel model)
		{
			base.Load(model);
		...
		public void Save(IRabbitMQExchangeModel model)
		{
