...
{
        public class OpcServerSurviveLooper : Looper
        {
                public OpcServerSurviveLooper(IIdentityObject parent)
                        : base(parent, "Opc服务器在线工作者")
                {
                }
                ...
                protected override sealed IResult Starup(IWorkContext context)
                {
                        ...
                        try
                        {
                                opcContext.NativeOpcServer.Connect(opcContext.Name);
                        }
                        catch (Exception ex)
                        {
